...
image:astra-ads-architecture-diagram-v2.png["Astra Control のアーキテクチャ図とコンポーネント"]
...
* * ストレージバックエンド * ：
+
** Astra Control Service で使用される https://www.netapp.com/cloud-services/cloud-volumes-service-for-google-cloud/["NetApp Cloud Volumes Service for Google Cloud"^] GKE クラスタおよびのバックエンドストレージとして AKS クラスタのバックエンドストレージとして。
