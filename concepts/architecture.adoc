...
* * ストレージバックエンド * ：
+
** Astra Control Service で使用される https://www.netapp.com/cloud-services/cloud-volumes-service-for-google-cloud/["NetApp Cloud Volumes Service for Google Cloud"^] GKE クラスタおよびのストレージバックエンドとして AKS クラスタのストレージバックエンドとして。
