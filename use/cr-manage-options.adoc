...
* link:../use/manage-apps.html#tech-preview-define-an-application-using-a-kubernetes-custom-resource["Kubernetesのカスタムリソースを使用してアプリケーションを定義する"]
* link:../use/manage-buckets.html#tech-preview-manage-a-bucket-using-a-custom-resource["カスタムリソースを使用したバケットの管理"]
