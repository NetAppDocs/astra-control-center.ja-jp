...
を参照してください https://["AWS の初期クレデンシャル"^]。
...
インストール手順については、を参照してください https://["AWS で OpenShift Container Platform にクラスタをインストールします"^]。
...
AWS のドキュメントに従って次の手順を実行します。を参照してください https://["AWS インストールドキュメント"^]。
...
* https://["AWS で Cloud Volumes ONTAP を使用するための準備"^]。
* https://["BlueXPを使用してAWSでコネクタを作成します"^]
...
* https://["GCPにOpenShiftクラスタをインストールする"^]
* https://["GCPサービスアカウントの作成"^]
...
BlueXPのマニュアルに従って'次の手順を実行しますを参照してください https://["GCPでCloud Volumes ONTAP の使用を開始する"^]。
...
.手順
. 資格情報をBlueXPに追加します。を参照してください https://["GCP アカウントの追加"^]。
. GCPのコネクターを追加します。
+
.. プロバイダーとして[GCP]を選択します。
.. GCP資格情報を入力します。を参照してください https://["BlueXPからGCPでコネクタを作成する"^]。
...
* https://["Azure への OpenShift クラスタのインストール"^]。
* https://["Azure アカウントをインストールする"^]。
...
を参照してください https://["Azure のクレデンシャルと権限"^]。
...
Azure のドキュメントに従って、次の手順を実行します。を参照してください https://["Azure への OpenShift クラスタのインストール"^]。
...
BlueXPのマニュアルに従って'次の手順を実行しますを参照してください https://["BlueXPの使用を開始しました"^]。
...
.手順
. 資格情報をBlueXPに追加します。
. Azure 用のコネクタを追加します。を参照してください https://["BlueXPポリシー"^]。
+
.. プロバイダとして「 * Azure * 」を選択します。
.. アプリケーション ID 、クライアントシークレット、ディレクトリ（テナント） ID など、 Azure クレデンシャルを入力します。
+
を参照してください https://["BlueXPrからAzureでコネクタを作成しています"^]。
