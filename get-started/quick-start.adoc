...
Astra Control Centerのセットアップが完了したら、Astra Control UIまたはを使用します https://docs.netapp.com/us-en/astra-automation/index.html["Astra Control API の略"^] アプリの管理と保護を開始するには：
